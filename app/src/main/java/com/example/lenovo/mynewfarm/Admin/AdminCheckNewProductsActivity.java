...
import com.example.lenovo.mynewfarm.Interface.ItemClickListner;
...
public class AdminCheckNewProductsActivity extends AppCompatActivity
{
    ...
    private void changeProdutsState(String productID)
    {
        unverifiedProductsRef.child(productID).child("productState").setValue("Approved").addOnCompleteListener(new OnCompleteListener<Void>() {
            ...
            {
                Toast.makeText(AdminCheckNewProductsActivity.this, "The selected product has been Approved.", Toast.LENGTH_SHORT).show();
